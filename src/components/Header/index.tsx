...
import { HeaderProps } from '@/types/marketPlace';
const playersData = [
  {
          ...
          <div className="relative w-full flex">
            ...
            <form className="relative search-header hidden 2xl:flex">
              ...
              <input
                ...
                autoComplete="search"
                required
                className="w-[150px] 2xl:w-[328px] h-12 pl-10 rounded-2xl text-[#A3A3A3] bg-[#ffffff00] rounded-2xl outline-0 border-0 py-1.5  ring-1 ring-inset placeholder:text-gray-400 sm:text-sm sm:leading-6 rounded-[16px_px] border-2 border-solid border-[#131740]"
                placeholder="Search"
              />
                ...
                <div className="hidden xl:flex">
                  ...
                  <Popover className="relative">
                    <Popover.Button
                      ...
                      className="ml-2  bg-button-transparent h-[40px] not-italic font-semibold text-xs rounded-full leading-[150%] flex items-center text-center w-auto min-w-max text-[#3C99FC] bg-[#31344C] px-4 py-0"
                    >
                      Área Clientes
                    </Popover.Button>
                  ...
                  <Link
                    ...
                    className="ml-2 bg-button-transparent h-[40px] not-italic font-semibold text-xs rounded-full leading-[150%] flex items-center text-center w-auto min-w-max text-[#00E4FF] bg-[#164092] px-4 py-0"
                  >
                    Área do Parceiro
                  </Link>
