...
import {
  customerRegisterAtlhetePJValidation,
...
const Step3Athlete = ({ data }: { data: any }) => {
  ...
  const handleShowErros = () => {
    ...
    for (const [key, value] of Object.entries(errors)) {
      if (key === 'legalGuardian') {
        for (const [LegalGuardian, valueLegalGuardian] of Object.entries(
          value
        )) {
    ...
    if (data?.pj.length) {
      return {
        ...
        legalGuardian: {
          ...
          cpf: data.legalGuardian.documentId.replace(/\D/g, '') || '',
        },
        gender: selectedGenderlegalGuardian.name || '',
        stateRegistration: data.documentIdNumber,
        hasCryptoWallet: false,
        registerType: data.registerType === 'ATLETA' ? 0 : 1 || null,
  ...
  const handleSubmit = async (values: any) => {
    ...
    console.log(selectedGenderlegalGuardian);

    values.registerType = data.registrationData?.registerType;
    values.inActivity = !!values.working;
    values.retired = !!values.retired;
    values.period = data.period;

    if (data?.registrationData?.registerType === 'ATLETA') {
      if (values.pj.length) {
        if (loading) return;
        setLoading(true);
        console.log(payload(values));
        try {
          await AuthService.signup.athlete(payload(values));
  ...
  useEffect(() => {
    (() => {
      if (!formik.values.pf.length) return;
      formik.values.pj = [];
      setFormType('PF');
    })();
  ...
  useEffect(() => {
    (() => {
      if (!formik.values.pj.length) return;
      formik.values.pf = [];
      setFormType('PJ');
    })();
      ...
      <Suspense fallback={<>Loading</>}>
        <div>
          <div className="lg:max-w-[430px] m-auto lg:ml-[5px]">
            <Header
              title="REGISTRAR NOVO ATLETA"
              description="Verifique qual perfil é o seu e realize o cadastro para ter acesso a todas as funções e benefícios do CHRONUS Sports"
            />
                ...
                <div className="mb-6">
                  <form onSubmit={formik.handleSubmit} className="text-white">
                    <div className="lg:max-w-[430px]">
                      <div>
                        <h2 className="not-italic font-normal text-base leading-[150%] text-[#EEEEEE] pb-[18px]">
                          Como você quer se registrar
                        </h2>

                        <div className="flex pb-[24px] max-w-[350px]">
                          <div className="w-max mr-4 flex">
                            <div className="text-sm leading-6 pr-4">
                              <label
                                htmlFor="pf"
                                className="not-italic font-normal text-base leading-[150%] text-neutral-400"
                              >
                                Pessoa física
                              </label>
                              ...
                              >
                                <span className="sr-only">Pessoa física</span>
                              </span>
                            </div>
                            <div className="flex h-6 items-center">
                              <input
                                id="pf"
                                aria-describedby="activy-description"
                                checked={!!formik.values.pf.length}
                                name="pf"
                                type="checkbox"
                          ...
                          <div className="w-max mr-4 flex">
                            <div className="text-sm leading-6 pr-4">
                              ...
                              <span
                                ...
                                className="text-gray-500"
                              >
                                <span className="sr-only">Pessoa jurídica</span>
                              </span>
                            </div>
                            ...
                            <div className="flex h-6 items-center">
                              <input
                                ...
                                name="pj"
                                type="checkbox"
                                checked={!!formik.values.pj.length}
                                onChange={formik.handleChange}
                                onBlur={formik.handleBlur}
                                className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600"
                              />
                      ...
                      <motion.div layout className="parent">
                        {!!formik.values.pf.length && (
                          <div className="child lg:max-w-[430px]">
                            <h2 className="not-italic font-normal text-base leading-[150%] text-[#EEEEEE] pb-7">
                              Informações gerais
                            </h2>
                              ...
                              <div className="sm:col-span-3">
                                ...
                                <div>
                                  <InputMask
                                    ...
                                    id="documentId"
                                    mask={
                                      formik.values.documentId.length === 11
                                        ? '999.999.999-99'
                                        : ''
                                    }
                              ...
                              <div className="sm:col-span-3">
                                ...
                                <div>
                                  <input
                                    ...
                                    className={`block w-full text-[#A3A3A3]  px-4 py-3 w-full bg-[#ffffff00] outline-0 border-0 py-1.5 placeholder:text-gray-400 sm:text-sm sm:leading-6 rounded-[16px] border-2 border-solid border-[#131740] rounded-2x shadow-none border-2 border-solid ${
                                      formik.errors.documentIdNumber
                                        ? ' border-[#CF2D2D]'
                                        : ''
                                    }`}
                                  />
                            ...
                            <div className="col-span-full pb-[24px]">
                              ...
                              <div className="relative mt-2 rounded-md shadow-sm">
                                ...
                                <input
                                  ...
                                  className={`block w-full pl-10 text-[#A3A3A3]  px-4 py-3 w-full bg-[#ffffff00] outline-0 border-0 py-1.5 placeholder:text-gray-400 sm:text-sm sm:leading-6 rounded-[16px] border-2 border-solid border-[#131740] rounded-2x shadow-none border-2 border-solid ${
                                    formik.errors.email
                                      ? ' border-[#CF2D2D]'
                                      : ''
                                  }`}
                            ...
                            <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 pb-[24px]">
                              <div className="sm:col-span-3 relative">
                                ...
                                <div>
                                  ...
                                  <div
                                    className="absolute left-0 flex items-center pl-4 right-0 pr-3 left-[unset] right-0 top-3.5"
                                    onClick={() =>
                              ...
                              <div className="sm:col-span-3 relative">
                                ...
                                <div>
                                  <input
                                    ...
                                    className={`block w-full text-[#A3A3A3] pl-10  px-4 py-3 w-full bg-[#ffffff00] outline-0 border-0 py-1.5 placeholder:text-gray-400 sm:text-sm sm:leading-6 rounded-[16px] border-2 border-solid border-[#131740] rounded-2x shadow-none border-2 border-solid ${
                      ...
                      <motion.div layoutId="underline" className="parent">
                        {!!formik.values.pj.length && (
                          <div className="child lg:max-w-[430px]">
                            <div>
                              <h2 className="not-italic font-normal text-base leading-[150%] text-[#EEEEEE] pb-7">
                                Informações gerais
                              ...
                              <div className="col-span-full pb-[24px]">
                                ...
                                <div>
                                  <InputMask
                                    ...
                                    className={`block w-full text-[#A3A3A3]  px-4 py-3 w-full bg-[#ffffff00] outline-0 border-0 py-1.5 placeholder:text-gray-400 sm:text-sm sm:leading-6 rounded-[16px] border-2 border-solid border-[#131740] rounded-2x shadow-none border-2 border-solid ${
                                      formik.errors.documentCompanyId
                                        ? ' border-[#CF2D2D]'
                                        : ''
                                    }`}
                                  />
                            ...
                            <div>
                              ...
                              <div className="col-span-full pb-[24px]">
                                ...
                                <div>
                                  <input
                                    ...
                                    className={`block w-full text-[#A3A3A3]  px-4 py-3 w-full bg-[#ffffff00] outline-0 border-0 py-1.5 placeholder:text-gray-400 sm:text-sm sm:leading-6 rounded-[16px] border-2 border-solid border-[#131740] rounded-2x shadow-none border-2 border-solid ${
                                      formik.errors?.legalGuardian?.name
                                        ? ' border-[#CF2D2D]'
                                        : ''
                                    }`}
                                  />
                              ...
                              <div className="col-span-full pb-[24px]">
                                <Select
                                  items={gender}
                                  key="legalGuardianGener"
                                  title=""
                                  data={{
                                    formik,
                                    selected: selectedGenderlegalGuardian,
                                    setSelected: setSelectedGenderLegalGuardian,
                                    errors:
                              ...
                              <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 pb-[24px]">
                                <div className="sm:col-span-3">
                                  <label
                                    htmlFor="legalGuardian.documentId"
                                    className="hidden block text-sm font-medium leading-6 text-gray-900"
                                  >
                                    CPF ou DNI *
                                  </label>
                                  <div>
                                    <InputMask
                                      ...
                                      onBlur={formik.handleBlur}
                                      value={
                                        formik.values?.legalGuardian?.documentId
                                      }
                                      className={`block w-full text-[#A3A3A3]  px-4 py-3 w-full bg-[#ffffff00] outline-0 border-0 py-1.5 placeholder:text-gray-400 sm:text-sm sm:leading-6 rounded-[16px] border-2 border-solid border-[#131740] rounded-2x shadow-none border-2 border-solid ${
                                        formik.errors?.legalGuardian?.documentId
                                          ? ' border-[#CF2D2D]'
                                          : ''
                                      }`}
                                    />
                              ...
                              <div className="col-span-full pb-[24px]">
                                ...
                                <div className="relative mt-2 rounded-md shadow-sm">
                                  ...
                                  <input
                                    ...
                                    className={`block w-full pl-10 text-[#A3A3A3]  px-4 py-3 w-full bg-[#ffffff00] outline-0 border-0 py-1.5 placeholder:text-gray-400 sm:text-sm sm:leading-6 rounded-[16px] border-2 border-solid border-[#131740] rounded-2x shadow-none border-2 border-solid ${
                                      formik.errors.legalGuardian?.email
                                        ? ' border-[#CF2D2D]'
                                        : ''
                                    }`}
                                    placeholder="E-mail *"
            ...
            <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 pb-[24px]">
                ...
                <div className="sm:col-span-3 relative">
                              ...
                              <InputMask
                                ...
                                onBlur={(event: any) => {
                                  formik.handleBlur(event),
                                    handleCEPSearch(formik.values.postalCode);
                                }}
                        ...
                        <div className="relative flex items-start">
                          ...
                          <div className="ml-3 text-sm leading-6">
                            ...
                            >
                              ...
                              <Link
                                href="/"
                                className="text-[#00E4FF] font-normal text-xs underline leading-5"
                              >
                        ...
                        <div className="relative flex items-start">
                          ...
                          <div className="ml-3 text-sm leading-6">
                            <label
                              ...
                              className="not-italic font-normal text-base leading-[150%] text-neutral-400"
                            >
                              Aceito os termos e condições estipulados no
                              contrato
                            </label>
                            <span
                              id="terms-description"
                    ...
                    <div className="mt-[49px] mb-[213px] lg:max-w-[430px]">
                      <button
                        type="submit"
                        onClick={handleShowErros}
                        style={{
                          background:
                            'linear-gradient(322.68deg, #803EB4 36.47%, #4F25CC 92.31%)',
                        }}
