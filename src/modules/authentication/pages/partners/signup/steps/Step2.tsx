...
const Step2 = ({ data }: { data: any }) => {
  ...
  const handleNext = () => {
    ...
    period &&
      selectedClub &&
      selectedModality &&
      data.registrationData.athleteType &&
  ...
  const AlertPeriod = () => {
    return (
      <>
        <Alert
          isOpen={isOpenAlert}
          toggle={() => setIsOpenAlert((prev) => !prev)}
        >
          <h2 className="not-italic font-black text-[38px] leading-[116%] flex items-center text-center tracking-[0.06em] uppercase text-white">
            ATENÇÃO
          </h2>
          <Image
            src="/assets/images/icoAlert.svg"
            height={32}
            width={32}
            alt=""
          ...
          <div className="mt-8">
            ...
            <div className="flex w-full max-w-full mt-[70px]  mb-[213px] m-auto justify-between items-center">
              <button
                type="button"
                name="step1"
                className="not-italic font-normal text-base leading-[150%] text-white flex"
                onClick={data?.handleBack}
              >
                <svg
                  className="ml-0 mr-2.5 mt-0.5 mb-0"
                  width="11"
                  height="18"
                  viewBox="0 0 11 18"
                  fill="none"
                ...
                >
                  <path
                    d="M3.99949 9L11 2.38859L9.00026 0.5L-1.01361e-07 9L9.00026 17.5L11 15.6114L3.99949 9Z"
                    fill="#164092"
                  />
                </svg>
                Voltar
