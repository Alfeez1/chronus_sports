...
import { items } from '@/constants/registration';
  ...
  return (
    <>
      <Suspense fallback={<p>Loading...</p>}>
        <div>
          <Header
            title="REGISTRAR NOVO TORCEDOR"
            description="Fique atento as dados que serão cadastrados, eles serão utilizados para gerar o seu contrato com a Plataforma CHRONUS Sports."
          />
            ...
            <div className="mt-8">
              <div className="mb-6">
                <form action="#" method="POST">
                  ...
                  <div className="col-span-full pb-[24px] relative "></div>
